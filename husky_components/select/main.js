 ...
 * @param {Array} [options.default] Array of default items that should be selected if no item has been preselected
 */
        ...
        initialize: function() {
            ...
            if (!this.options.preSelectedElements || this.options.preSelectedElements.length === 0) {
                ...
                if (typeof selectedIds === 'string') {
                    ...
                    this.options.preSelectedElements = this.options.default;
                }
            }
