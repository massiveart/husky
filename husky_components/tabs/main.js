 ...
 *      - tabChangeAllowed: funtion that checks if tab change is allowed
    ...
    var defaults = {
        ...
        selectItem = function(event) {
            ...
            if (this.active === true && this.sandbox.dom.hasClass(event.currentTarget, 'is-selected') !== true) {
                ...
                if (typeof this.options.tabChangeAllowed === 'function') {
                    this.options.tabChangeAllowed().then(function () {
